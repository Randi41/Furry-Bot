...
const fkgif = {
	 ...
	 { remoteJid: "6285752583246-6289509340893@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":`RANN BOT WA 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `RANN BOT WA 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: RANN BOT WA*
⚘ *Creator: RANN D*
⚘ *Contact Owner Bot*
*http://wa.me/6285752583246*
⚘ *Tanggal: ${date}*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
 ...
       const sections = [
                              {
                                "rows": [{
                                         ...
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ BOTWA RANN",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
